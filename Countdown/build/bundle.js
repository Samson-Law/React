...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Countdown = function (_React$Component) {
	    ...
	    function Countdown(props) {
	        ...
	        _this.state = {
	            time1: [],
	            time2: [],
	            seconds: _this.props.remainingSecond,
	            animation: true
	        };
	        _this.timer = 0;
	    ...
	    _createClass(Countdown, [{
	        ...
	        key: "slideup",
	        value: function slideup(current, updates) {
	            var slideupClass = '';
	            if (current == updates || this.state.animation == false) slideupClass = '';else slideupClass = 'sliding-up';
	            return slideupClass;
	        }
	    }, {
	        key: "componentDidMount",
	        value: function componentDidMount() {
	            var maxSecondTime = 360000,
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        "div",
	                        { className: 'd1 ' + this.slideup(this.state.time1.Hd1, this.state.time2.Hd1) },
	                        _react2.default.createElement(
	                            "div",
	                            null,
	                            this.state.time1.Hd1
	                        ),
	                        _react2.default.createElement(
	                            "div",
	                            null,
	                            this.state.time2.Hd1
	                        )
	                    ),
	                    _react2.default.createElement(
	                        "div",
	                        { className: 'd2 ' + this.slideup(this.state.time1.Hd2, this.state.time2.Hd2) },
	                        _react2.default.createElement(
	                            "div",
	                            null,
	                            this.state.time1.Hd2
	                        ),
	                        _react2.default.createElement(
	                            "div",
	                            null,
	                            this.state.time2.Hd2
	                        )
	                    )
	                ),
	                _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        "div",
	                        { className: 'd1 ' + this.slideup(this.state.time1.Md1, this.state.time2.Md1) },
	                        _react2.default.createElement(
	                            "div",
	                            null,
	                            this.state.time1.Md1
	                        ),
	                        _react2.default.createElement(
	                            "div",
	                            null,
	                            this.state.time2.Md1
	                        )
	                    ),
	                    _react2.default.createElement(
	                        "div",
	                        { className: 'd2 ' + this.slideup(this.state.time1.Md2, this.state.time2.Md2) },
	                        _react2.default.createElement(
	                            "div",
	                            null,
	                            this.state.time1.Md2
	                        ),
	                        _react2.default.createElement(
	                            "div",
	                            null,
	                            this.state.time2.Md2
	                        )
	                    )
	                ),
	                _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        "div",
	                        { className: 'd1 ' + this.slideup(this.state.time1.Sd1, this.state.time2.Sd1) },
	                        _react2.default.createElement(
	                            "div",
	                            null,
	                            this.state.time1.Sd1
	                        ),
	                        _react2.default.createElement(
	                            "div",
	                            null,
	                            this.state.time2.Sd1
	                        )
	                    ),
	                    _react2.default.createElement(
	                        "div",
	                        { className: 'd2 ' + this.slideup(this.state.time1.Sd2, this.state.time2.Sd2) },
	                        _react2.default.createElement(
	                            "div",
	                            null,
	                            this.state.time1.Sd2
	                        ),
	                        _react2.default.createElement(
	                            "div",
	                            null,
	                            this.state.time2.Sd2
	                        )
	                    )
	                )
	            );
	...
	var App = function (_React$Component2) {
	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            var number = 240;
	            return _react2.default.createElement(Countdown, { remainingSecond: number, onComplete: function onComplete() {
	                    return alert("Done");
	                } });
	        }
	    }]);
